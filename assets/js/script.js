...
function validateForm(){
    ...
    let regEmail=/^([a-zA-Z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/gm;
    let regPhone=/^\d{10}$/;
    let regName = /\d+$/g;
    ...
    if (phone == "" || !regPhone.test(phone)) {
      displayError.innerHTML = "Please enter a valid Phone";
...
$("#submit-form").submit((e) => {
	...
	if (check) {
		$.ajax({
			url: "https://script.google.com/macros/s/AKfycbzcO5FklsnIchUtBTV1M5G18wxcHXV1_I3qlVQScyKNTM4_5pmSt3xVZkXdhfR9E08M/exec",
